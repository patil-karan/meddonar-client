...
function Login() {
  ...
  return (
    <main className="w-full h-screen flex flex-col items-center justify-center pb-4 bg-stone-50">
      <div className="max-w-2xl p-10 shadow-xl rounded-md ">
        <div className="max-w-2xl w-full text-gray-600 space-y-5">
