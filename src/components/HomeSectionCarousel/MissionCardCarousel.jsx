...
import MissionCard from '../HomeSectionCard/MissionCard';
import { Button } from '@mui/material';
import KeyboardArrowLeftIcon from '@mui/icons-material/KeyboardArrowLeft';

const MissionCardCarousel = ({data,sectionName}) => {
  ...
  const items = data.map((item) => <MissionCard product={item} key={item.title} />);
...
export default MissionCardCarousel;
